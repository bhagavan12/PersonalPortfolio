      ...
      <div className="hero--section--content--box">
        ...
        <div class="">
          ...
          <div class="bh-overflow-hidden">
            <h1 class="drop-right">Hi! My name is Sai Bhagavan</h1>
          </div>
          <div class="bh-overflow-hidden">
            <p class="bh-drop-in-2">
              I am a Student, and
              I'm very passionate and dedicated to my study. I can
              utilize my skills and enhance learning in the filed of
              work. Capable of mastering new source ideas.l have
